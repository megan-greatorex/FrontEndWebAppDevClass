...
function setGreeting(name) {
  ...
  if (firstLetter === 'j') {
    name = byeSpeaker.speak(name);
  } else {
    name = helloSpeaker.speak(name);
  }
}
...
for (var greeting in initialValue.hello){
  console.log(initialValue.hello[greeting]);
}

for (var greeting in initialValue.bye){
  console.log(initialValue.bye[greeting]);
}
